import type { Command, ParseError } from "@spawn-dev/lib/core/domain"
import { createProject } from "@spawn-dev/lib/usecases/actions"
import { applyProjectConfig } from "@spawn-dev/lib/usecases/apply"
import {
  authClaudeLogin,
  authClaudeLogout,
  authClaudeStatus,
  ...
  authGithubLogout,
  authGithubStatus
} from "@spawn-dev/lib/usecases/auth"
import type { AppError } from "@spawn-dev/lib/usecases/errors"
import { renderError } from "@spawn-dev/lib/usecases/errors"
import { mcpPlaywrightUp } from "@spawn-dev/lib/usecases/mcp-playwright"
import { downAllDockerGitProjects, listProjectStatus } from "@spawn-dev/lib/usecases/projects"
import { exportScrap, importScrap } from "@spawn-dev/lib/usecases/scrap"
import {
  stateCommit,
  stateInit,
  statePath,
  ...
  stateStatus,
  stateSync
} from "@spawn-dev/lib/usecases/state-repo"
import {
  killTerminalProcess,
  listTerminalSessions,
  tailTerminalLogs
} from "@spawn-dev/lib/usecases/terminal-sessions"
