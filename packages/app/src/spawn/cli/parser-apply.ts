...
import { type ApplyCommand, type ParseError } from "@spawn-dev/lib/core/domain"
import { normalizeCpuLimit, normalizeRamLimit } from "@spawn-dev/lib/core/resource-limits"

import { parseProjectDirWithOptions } from "./parser-shared.js"

// CHANGE: parse "apply" command for existing spawn projects
// WHY: update managed spawn config on the current project/container without creating a new project
