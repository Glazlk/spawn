...
import { type AuthCommand, type Command, type ParseError } from "@spawn-dev/lib/core/domain"
...
const defaultEnvGlobalPath = ".spawn/.orch/env/global.env"
const defaultCodexAuthPath = ".spawn/.orch/auth/codex"
const defaultClaudeAuthPath = ".spawn/.orch/auth/claude"
const defaultGeminiAuthPath = ".spawn/.orch/auth/gemini"
...
// WHY: enable Gemini CLI authentication management via spawn CLI
...
// CHANGE: parse spawn auth subcommands
