import { type MenuAction, type ProjectConfig } from "@spawn-dev/lib/core/domain"
import { readProjectConfig } from "@spawn-dev/lib/shell/config"
import { runDockerComposeDown, runDockerComposeLogs, runDockerComposePs } from "@spawn-dev/lib/shell/docker"
import { gcProjectNetworkByTemplate } from "@spawn-dev/lib/usecases/docker-network-gc"
...
} from "@spawn-dev/lib/usecases/projects"
...
const runDownAllAction = (context: MenuContext) => {
  context.setMessage(null)
  runWithSuspendedTui(downAllDockerGitProjects, context, "Stopping all spawn containers")
}
